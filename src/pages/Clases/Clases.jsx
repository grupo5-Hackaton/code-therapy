      ...
      <div className="card-contenedor">
        ...
        <div className="centrado">
          <img
            ...
            src={hero}
            alt="imagen de una chica con portatil y cohete despegando"
          />
        </div>
      </div>
      ...
      <section className="fondo-azul-claro">
        <div className="card-contenedor">
          ...
          <CardClaseDestacada
            ...
            descripcion={
              "Mis clases particulares están enfocadas a personas que quieren aprender JS desde 0."
            }
            precio={15}
          />
          <CardClaseDestacada
            ...
            descripcion={
              "¿Quieres aprender la Programación Orientada a Objetos en Python? ¡Esta es tu clase? "
            }
            precio={20}
          />
          <CardClaseDestacada
            ...
            titulo={"Fundamentos de JS"}
            descripcion={
              "Typescript tiene muchas ventajas. ¡Conócelas y empieza a utilizar TS en tu próximo proyecto!"
            }
            precio={20}
          />
        </div>
